...
"padding-bottom:7px;")
        ...
        self.pushButton.clicked.connect(self.validate_login)  # Connect to validate login method
    ...
    def validate_login(self):
        ...
        # Load the JSON data
        with open(r'C:\Users\Hp\Downloads\SC_pyqt5_LoginUI4-main\SC_pyqt5_LoginUI4-main\loginUi4\users.json', 'r') as file:
             data = json.load(file)

        # Check if the username and password match
        for user in data['users']:
            if user['username'] == username and user['password'] == password:
                QtWidgets.QMessageBox.information(None, 'Login Successful', 'Welcome, ' + username + '!')
                
                # Register the Chrome browser with a specific path
